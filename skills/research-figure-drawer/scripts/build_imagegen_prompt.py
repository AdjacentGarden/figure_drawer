...
def build_prompt(spec: dict) -> str:
    ...
    sections = [
        ...
        *(f'- "{value}"' for value in exact),
        ...
        "- reserve dedicated empty lanes for formulas and connector routing; never place a connector behind a label or equation",
        "- keep at least one visible padding unit between text ink and its containing border, and between neighboring labeled modules",
        "- depict simple geometric motifs canonically: shared vertices, parallel opposite edges, equal repeated spacing, and consistent perspective",
